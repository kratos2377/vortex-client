...
#[tauri::command]
pub async fn send_request(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn get_user_friend_requests(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn accept_or_reject_request(payload: String ,token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn add_wallet_address(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn get_user_wallets(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn delete_wallet_address(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
...
#[tauri::command]
pub async fn get_all_users_friends(payload: String , token: String, state: State<'_ , WebClient>) -> Result<String , Error> {
