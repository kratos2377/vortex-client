      ...
      <div className="fixed inset-0 flex items-center justify-center self-center z-50">
        ...
        <div className="bg-white rounded-lg p-8 z-50">
          ...
          { requestSent ? <span className="loading loading-dots loading-lg"></span> : <div className='mt-2'> 
            ...
            >
              <option value="game-select">Select</option>
              <option value="chess">Chess</option>
              <option value="poker" disabled={true}>Poker</option>
              <option value="scribble" disabled={true}>Scribble</option>
            </select>
          </div>
          <div className="mb-4">
            ...
            >
              ...
              <option value="staked" disabled={true}>Staked</option>
